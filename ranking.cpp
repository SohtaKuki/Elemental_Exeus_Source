...
HRESULT CRanking::Init(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\RST_SCORE_NUMBER.png", &m_pTextureRankingscore);
	...
	//SetRankingPos(D3DXVECTOR3(550.0f, 22590.0f, 0.0f), 6);
...
void CRanking::Update(void)
{
	...
	{
		for (nCountRank = 0; nCountRank < 8; nCountRank++)
		{
			//テクスチャ座標の設定	
	...
	{
		//m_nCounterRankingState++;
		//if (m_nCounterRankingState >= 60)
		//{
		//	m_nCounterRankingState = 60;
...
void CRanking::SetRanking(int nScore)
{
	...
	for (nCountRank = 0; nCountRank < MAX_RANK; nCountRank++)
	{
		m_aPosTexU[nCountRank][0] = m_aRankScore[nCountRank].nScore % 100000000 / 10000000;
		m_aPosTexU[nCountRank][1] = m_aRankScore[nCountRank].nScore % 10000000 / 1000000;
		m_aPosTexU[nCountRank][2] = m_aRankScore[nCountRank].nScore % 1000000 / 100000;
		m_aPosTexU[nCountRank][3] = m_aRankScore[nCountRank].nScore % 100000 / 10000;
		m_aPosTexU[nCountRank][4] = m_aRankScore[nCountRank].nScore % 10000 / 1000;
		m_aPosTexU[nCountRank][5] = m_aRankScore[nCountRank].nScore % 1000 / 100;
		m_aPosTexU[nCountRank][6] = m_aRankScore[nCountRank].nScore % 100 / 10;
		m_aPosTexU[nCountRank][7] = m_aRankScore[nCountRank].nScore % 10 / 1;
	}
}
