//=================================================
//
// 3Dモデルのブロックの処理 (3dtornadoEnemy.h)
// Author: Sohta Kuki
//
//=================================================

#ifndef _3DSLASHTORNADO_ENEMY_H_
#define _3DSLASHTORNADO_ENEMY_H_
...
//オブジェクト3Dクラス
class C3dtornadoEnemy : public CObject3D
{
public:
	...
	C3dtornadoEnemy(int nPriority = 3);
	~C3dtornadoEnemy() override;
	HRESULT Init()override;
	void Uninit()override;
	void Update()override;
	void Draw()override;
	static C3dtornadoEnemy* Create(D3DXVECTOR3 pos, int nDirection);
	...
	bool Collision3DTornadoEnemy(D3DXVECTOR3* pPos, D3DXVECTOR3* pPosOld, D3DXVECTOR3* pMove, float fWidth, float fHeight);
