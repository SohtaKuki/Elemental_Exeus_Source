//=================================================
//
// 3Dモデルのブロックの表示処理 (3dslashwindEnemy.cpp)
// Author: Sohta Kuki
//
//=================================================
...
bool C3dslashwindEnemy::m_bComboDest = false;

//======================
// コンストラクタ
//======================
C3dslashwindEnemy::C3dslashwindEnemy(int nPriority) : CModel(nPriority)
{
    m_nTurnCnt = 0;
    m_bTurn = false;
}
...
// デストラクタ
//======================
C3dslashwindEnemy::~C3dslashwindEnemy()
{
...
// 初期化処理
//======================
HRESULT C3dslashwindEnemy::Init()
{
    //初期化
...
void C3dslashwindEnemy::Uninit()
{
    ...
    // メッシュやマテリアルの解放
    for (int i = 0; i < SLASHWINDENEMY_MODEL; i++)
    {
...
void C3dslashwindEnemy::Draw()
{
    ...
    for (int nCntParts = 0; nCntParts < SLASHWINDENEMY_MODEL; nCntParts++)
    {
        //ワールドマトリックスの初期化
...
// オブジェクト生成処理
//======================
C3dslashwindEnemy* C3dslashwindEnemy::Create(D3DXVECTOR3 pos)
{
    C3dslashwindEnemy* D3DSlashWind = nullptr;

    D3DSlashWind = new C3dslashwindEnemy;

    //初期化に成功した場合
    if (SUCCEEDED(D3DSlashWind->Init()))
    {
        D3DSlashWind->SetType(TYPE::SLASHWINDENEMY);
...
// テクスチャロード処理
//======================
HRESULT C3dslashwindEnemy::Load()
{
    LPDIRECT3DDEVICE9 pDevice = nullptr;
    pDevice = CManager::GetRenderer()->GetDevice();
...
// 外部ファイル読み込み処理
//===========================
void C3dslashwindEnemy::LoadBlockData(void)
{
...
// ブロックの当たり判定
//===========================
bool C3dslashwindEnemy::Collision3DBlock(D3DXVECTOR3* pPos, D3DXVECTOR3* pPosOld, D3DXVECTOR3* pMove, float fWidth, float fHeight)
{
