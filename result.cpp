...
// オブジェクト生成処理
//======================
CResultBG* CResultBG::Create(D3DXVECTOR3 pos, D3DXVECTOR3 size,int nType)
{
	...
	{
		//テクスチャの読み込み
		D3DXCreateTextureFromFile(CManager::GetRenderer()->GetDevice(), "data\\TEXTURE\\resultfailed000.png", &pTexture);
		ResultBG->BindTexture(pTexture);
