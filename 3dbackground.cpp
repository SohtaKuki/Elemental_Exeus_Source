//=================================================
//
// 3Dモデルのブロックの表示処理 (3dbackground.cpp)
// Author: Sohta Kuki
//
//=================================================
...
void C3dbackground::LoadBackGroundData(void)
{
    ...
    if (m_nType == 0)
    {
        m_pFile = fopen("data\\MODEL\\MODEL_BACKGROUND\\background000.txt", "r");//ファイルを開く
    }

    if (m_nType == 1)
    {
        m_pFile = fopen("data\\MODEL\\MODEL_BACKGROUND\\background001.txt", "r");//ファイルを開く
    }

    if (m_nType == 2)
    {
        m_pFile = fopen("data\\MODEL\\MODEL_BACKGROUND\\bgtorch000.txt", "r");//ファイルを開く
    }

    if (m_nType == 3)
    {
        m_pFile = fopen("data\\MODEL\\MODEL_BACKGROUND\\background0099.txt", "r");//ファイルを開く
    }
